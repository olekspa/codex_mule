"""Config flow for Codex Mule conversation integration."""
...
class CodexMuleConversationConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Codex Mule conversation."""
    ...
    async def async_step_user(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult:
        ...
        await self.async_set_unique_id("codex_mule_conversation_default")
